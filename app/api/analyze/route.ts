...
function analyzeSajuMaster(saju: any) {
  ...
  const COLOR_MAP: Record<string, string> = {
    '목': '청록색, 녹색 계열', '화': '붉은색, 주황색 계열',
    '토': '황색, 갈색 계열', '금': '흰색, 은색 계열', '수': '검정색, 남색 계열',
  }
  const DIR_MAP: Record<string, string> = {
    '목': '동쪽, 동남쪽', '화': '남쪽, 남동쪽', '토': '중앙, 인근지역', '금': '서쪽, 서북쪽', '수': '북쪽, 북서쪽',
  }
  ...
  return {
    ...
    luckyDirection: DIR_MAP[yongshin] || '동쪽',
    avoidDirection: AVOID_DIR_MAP[kishin] || '북쪽',
